...
const { get_project_directory, parse_inventory_csv, use_extra_mapping } = require('../');
...
async function parse_inventory() {
    ...
    const result = await parse_inventory_csv(inventory_filepath, fields_maps, agreed_header, use_extra_mapping());
