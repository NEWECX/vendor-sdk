...
module.exports = async (result, options) => {
    ...
    if (options && options.summary_report) {
        try {
            ...
            console.error('call options.summary_report', err.message.red);
    ...
    if (options && options.errors_report) {
        try {
            ...
            console.error('call options.errors_report', err.message.red);
            if (process.env.DEBUG) {
                console.error(err);
            }
        }
    ...
    if (options && options.warning_report) {
        try {
            ...
            console.error('options.warning_report', err.message.red);
            if (process.env.DEBUG) {
                console.error(err);
            }
        }
    ...
    if (options && options.passed_report) {
        try {
            ...
            console.error('options.passed_report', err.message.red);
            if (process.env.DEBUG) {
                console.error(err);
            }
        }
    ...
    if (options && options.std_inventory_report) {
        try {
            ...
            console.error('options.std_inventory_report', err.message.red);
            if (process.env.DEBUG) {
                console.error(err);
            }
        }
