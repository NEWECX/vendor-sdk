 ...
 * @returns 
 */
 module.exports = async (diamonds, show_result = false, is_asset_existed = local_is_asset_existed) => {
    ...
    for (const diamond of diamonds) {
        ...
        for (const field in assets_filename_map) {
            ...
            promises.push(download_from_url(url, filenames, diamond_path, stats, ok_status, {field, show_result}));
