...
const std_fields = [
	...
	},
	{
		...
		dependencies: ['carat', 'cost_per_carat'],
		type: 'number',
		match: [{in: ['^cost','price', '^cash', '^total price']}, {nin: ['per', 'discount', '%', '/ct']}]
	},
	{
		key: 'cost_per_carat',
	...
	{
		key: 'culet', 
		values_map: combine_map_and_reverse_map('culet'),
		description: 'culet',
		require: 'required', 
		type: 'string',
	...
	},
	{
		...
		dependencies: ['length', 'width', 'depth'],
		type: 'string',
		match: [{ in: ['measure']}]
	},
	{
	...
	},
	{
		...
		type: 'string',
		dependencies: ['girdle_thin', 'girdle_thick'],
	...
	},
	{
		...
		require: 'optional', 
		type: 'string',
		match: [{ in: ['^girdle']}, { in: ['thin', 'min']}, {nin: ['%', 'per']}]
	},
	{
		key: 'girdle_thick',
		...
		require: 'optional', 
		type: 'string',
		match: [{ in: ['^girdle']}, { in: ['thick', 'max']}, {nin: ['%', 'per']}]
	},
	{
		key: 'girdle_percent',
	...
	},
	{
		...
		dependencies: ['city', 'state', 'country'],
		type: 'string',
		match: [{ in: ['location']}]
	},
	{
