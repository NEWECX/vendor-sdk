...
const assets_filename_map = {
    orig_certificate_url: ['certificate.pdf', 'certificate.jpg', 'certificate.png'], 
...
const filename_values = Object.values(assets_filename_map).reduce((x, a) => ([...x, ...a]), []);
...
const assets_types_values = Array.from(new Set(Object.values(assets_stats_types)));
